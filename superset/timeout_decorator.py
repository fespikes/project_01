...
Timeout decorator.
    ...
    :copyright: (c) 2012-2013 by PN. https://github.com/pnpnpn/timeout-decorator
...
from superset.message import CONNECTION_TIMEOUT
...
def timeout(seconds=None,
    ...
    :param seconds: optional time limit in seconds or fractions of a second.
        If None is passed, no timeout is applied. This adds some flexibility
        to the usage: you can disable timing out depending on the settings.
    :type seconds: float
    :param use_signals: flag indicating whether signals should be used for timing
        function out or the multiprocessing When using multiprocessing, timeout
        granularity is limited to 10ths of a second.
    ...
    def decorate(function):
        ...
        if use_signals:
            ...
            def new_function(*args, **kwargs):
                timeout_wrapper = \
                    _Timeout(function, timeout_exception, exception_message, seconds)
