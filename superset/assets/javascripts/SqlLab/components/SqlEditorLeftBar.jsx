    ...
    return (
      <div className="scrollbar-container">
        <div className="clearfix sql-toolbar scrollbar-content">
          {networkAlert}
          <div>
            <div className="select-title">数据库</div>
            <AsyncSelect
          ...
          <div className="m-t-5">
            <div className="select-title">项目 ({this.state.schemaOptions.length})</div>
            <Select
              name="select-schema"
              placeholder={`选择一个项目 (${this.state.schemaOptions.length})`}
          ...
          <div className="m-t-5">
            <div className="select-title">添加表 ({this.state.tableOptions.length})</div>
            <Select
              name="select-table"
              ref="selectTable"
