...
function chinaMap(slice) {
    ...
    const render = function() {
        ...
        d3.json(slice.jsonEndpoint(), function(error, json) {
            ...
            let rename_bubble_metric = fd.rename_bubble_metric || fd.metric;
            let rename_color_metric = fd.rename_color_metric || fd.secondary_metric;
                        ...
                        (function(circle, state) {
                            ...
                            $(circle[0]).hover(function(e) {
                                if (e.type == 'mouseenter') {
                                    $tiplayer.text(china[state]['name'] + ' ' + rename_bubble_metric + ' ' + bubbleFormat(china[state].m1)).css({
                                        'opacity': '0.95',
                                        'top': (e.pageY + 10) + 'px',
                                        'left': (e.pageX + 10) + 'px',
                                        'background': '#fff',
                    ...
                    if (fd.show_colors) {
                        ...
                        (function(st, state) {
                            ...
                            $(st[0]).hover(function(e) {
                                ...
                                if (e.type == 'mouseenter') {
                                    $tiplayer.text(china[state]['name'] + ' ' + rename_color_metric + ' ' + colorFormat(china[state].m2)).css({
                                        'opacity': '0.85',
                                        'top': (e.pageY + 10) + 'px',
                                        'left': (e.pageX + 10) + 'px',
                                        'background': '#fff',
    ...
    renderMap = function(b) {
        ...
        china.aomen = {
            name: "澳门特区",
            path: R.path("M413.032,414.183l-0.96,1.752c0,0,0.889,0.883,1.98,1.086s1.995-0.493,1.995-0.493L413.032,414.183z")
        };
        china.hongkong = {
            name: "香港特区",
            path: R.path("M417.745,409.005l3.394,0.773l3.453-2.558l1.666,4.582c0,0-5.521,2.673-3.691,1.785c1.828-0.884-4.641-0.355-4.641-0.355l-0.834-3.454L417.745,409.005z")
        };
        china.taiwan = {
            name: "台湾",
            path: R.path("M505.438,371.203l-3.217,19.169l-1.664,6.07v5.123l-1.43,1.427l-3.451-5.119l-3.693-2.858l-3.215-8.571c0,0-0.451-5.62,0.357-7.74c0.809-2.118,5.356-14.05,5.356-14.05l6.313-5.357l4.051,1.904L505.438,371.203z")
        };
        china.guangdong = {
            name: "广东省",
        ...
        china.hainan = {
            name: "海南省",
            path: R.path("M385.895,447.523l-5.119,8.93v3.929l-10.238,8.336l-10.598-3.689l-2.025-7.501l0.597-3.454c0,0,8.074-8.075,5.715-5.716c-2.357,2.358,2.025-1.665,2.025-1.665l9.403-1.668l4.289-0.358l1.426-1.666l3.103,0.832L385.895,447.523z")
        };
        china.yunnan = {
            name: "云南省",
        ...
        china.shanghai = {
            name: "上海市",
            path: R.path("M484.32,292.485l-3.998-3.332c0,0,0.867-0.375,1.898-2.251c1.031-1.875,1.426-4.286,1.426-4.286l4.287,1.788l2.027,2.854l-1.433,2.024L484.32,292.485z")
        };
        china.jiangsu = {
            name: "江苏省",
        ...
        china.tianjin = {
            name: "天津市",
            path: R.path("M430.413,200.491c0,0-1.832,1.672-3.319,1.284c-1.49-0.388-5.479-1.428-5.479-1.428l-0.237-1.429l-0.238-9.169l3.69-1.667l-0.596-1.666l0.81-3.557l0.385-1.683l1.901,0.95l0.953,3.098l-0.356,2.022l4.047,2.858l0.594,2.263l-2.379,1.668l-0.834,3.809L430.413,200.491z")
        };
        china.beijing = {
            name: "北京市",
            url: 'http://www.baidu.com/',
            path: R.path("M421.139,189.75l-0.357-2.856l-0.832-1.905l5.095-2.126l0.381-1.683l-1.189-4.767h-1.668l-6.666-3.449l-3.69,3.69c0,0-1.125,6.585-0.832,4.88c0.289-1.704-3.693,4.288-3.693,4.288l-0.594,4.286l0.832,2.263l4.881-0.834l3.693,1.071l1.784-1.667L421.139,189.75z")
        };
        china.ningxia = {
            name: "宁夏回族自治区",
