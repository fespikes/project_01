...
def create_cas_callback_url(local_addr, callback_route):
    """ Create a CAS callback URL.

    """
    return create_url(local_addr, callback_route)


def create_cas_proxy_url(cas_url, cas_route, target_service, pgt):
